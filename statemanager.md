...
The singleton design pattern is a software engineering paradigm where a class is designed with the understanding that only 1 instance of the class will ever be created. [Singleton Design Pattern](https://en.wikipedia.org/wiki/Singleton_pattern)
